...
export const metadata = {
  title: "Terms & Conditions | CAM Covers",
  description: "Terms and conditions for using CAM Covers app.",
}
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-24">
        <article className="prose prose-purple max-w-4xl mx-auto">
          ...
          <ul>
          <li>
          <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named CAM Covers</p>
          </li>
          <li>
          ...
          <li>
          <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to CAM Covers.</p>
          </li>
          <li>
          ...
          <ul>
          <li>By email: tiagodanin@outlook.com</li>
          </ul>
        </article>
      </main>
      <Footer />
